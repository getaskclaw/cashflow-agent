  ...
  try {
      ...
      include: {
        ...
        communications: {
          ...
          select: {
            ...
            agentDraft: true, approved: true, sentAt: true, createdAt: true,
            parsedStatus: true, parsedPromiseDate: true, parsedSummary: true,
          },
        },
      },
    });
    ...
    return NextResponse.json({
      invoice: {
        ...
        currency: invoice.currency, description: invoice.description,
      ...
      communications: invoice.communications.map((c) => ({
        id: c.id, direction: c.direction, channel: c.channel, content: c.content,
        agentDraft: c.agentDraft, approved: c.approved,
